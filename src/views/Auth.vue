<template>
  <div>
    ...
    <div class="bg-gray-400 h-screen overflow-hidden flex items-center justify-center">
      <div class="rounded-3xl bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
        ...
        <form @submit="onSubmit" class="p-12 md:p-24">
          <div class="flex items-center text-lg mb-6 md:mb-8">
            <svg class="absolute ml-3" width="24" viewBox="0 0 24 24">
              <path
                d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z" />
            </svg>
            <Field name="email" type="text" id="email" class="
                rounded-3xl bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full"
              placeholder="email" />
            <ErroMessage name="email" class="text-red-500 text-sm"></ErroMessage>
          </div>
          <div class="flex items-center text-lg mb-6 md:mb-8">
            ...
            <Field name="password" type="Password" id="password"
              class="rounded-3xl bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
            <ErrorMessage name="password" class="text-red-500 text-sn"></ErrorMessage>
          </div>
          <button type="submit"
            class="rounded-xl bg-gradient-to-b from-blue-600 to-blue-700 font-medium p-1 md:p-4 text-white  w-full">Login</button>
        </form>
      </div>
    </div>
  </div>
