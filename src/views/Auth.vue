  ...
  <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    ...
    <form @submit="onSubmit" class="p-12 md:p-24">
      <div class="flex items-center text-lg mb-6 md:mb-8">
        ...
        <Field name="email" 
        type="text" id="email" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="email" />
      ...
      <div class="flex items-center text-lg mb-6 md:mb-8">
        ...
        id="password" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
