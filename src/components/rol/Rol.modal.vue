    ...
    <div class="w-[81.5%] h-[18%] left-[18.5%] z-20 absolute">
        <section class="flex p-10 justify-center items-start ">
            <button onclick="document.getElementById('myModal').showModal()" id="btn"
                class="py-3 px-10 bg-gray-800 text-white rounded text shadow-xl">Crear rol</button>
        </section>
                    ...
                    <form class="flex flex-col space-y-4">
                        <div class="mb-4">
                            ...
                            <input type="text" id="rolName" name="rolName"
                                ...
                                <label for="rolName" class="block text-sm font-medium text-gray-700">Rol Activo</label>
                            <input type="text" id="rolName" name="rolName"
                                class="mt-1 p-2 block w-full rounded-md bg-white border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <!-- Botones -->
                        <div class="flex justify-center space-x-4">
                            <button type="submit"
                                class="px-4 py-2 bg-indigo-500 text-white rounded hover:bg-indigo-600">Crear Rol</button>
                            <button type="button"
