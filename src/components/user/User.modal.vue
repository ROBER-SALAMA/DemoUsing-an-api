            ...
            <div class="flex flex-col w-full h-auto">
                ...
                <div 
                    ...
                    <form class="flex flex-col space-y-4" @submit="onSubmit">
                        ...
                        <div class="mb-4">
                            <Field type="text" id="user" name="name" placeholder="Nombre"
                            ...
                            <Field type="text" id="user" name="lastName" placeholder="Apellido"
                            ...
                            <Field type="text" id="user" name="age" placeholder="Edad"
                                class="mt-2 p-2 block w-full rounded-md bg-white border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                            <Field type="text" id="user" name="gender" placeholder="Genero"
                                class="mt-2 p-2 block w-full rounded-md bg-white border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
